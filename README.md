...
# R Version Metadata
    ...
    FALSE  [1] surveyresamplr_0.0.1   readr_2.1.5            Require_1.0.1          fontawesome_0.5.3      FishStatsUtils_2.13.2  marginaleffects_0.25.1
    FALSE  [7] units_0.8-7            ggspatial_1.1.9        pkgdown_2.1.1          roxygen2_7.3.2         RODBC_1.3-26           sp_2.2-0              
    FALSE [13] httr_1.4.7             jsonlite_1.9.1         nwfscSurvey_2.2        coldpool_3.4-3         viridis_0.6.5          stringr_1.5.1         
    FALSE [19] reshape2_1.4.4         lubridate_1.9.4        fields_16.3.1          viridisLite_0.4.2      spam_2.11-1            gstat_2.1-3           
    FALSE [25] ggthemes_5.1.0         akgfmaps_4.0.3         terra_1.8-29           stars_0.6-8            abind_1.4-8            sf_1.0-19             
    FALSE [31] here_1.0.1             janitor_2.2.1          tibble_3.2.1           ggplot2_3.5.2          tidyr_1.3.1            magrittr_2.0.3        
    FALSE [37] dplyr_1.1.4            plyr_1.8.9             remotes_2.5.0          devtools_2.4.5         usethis_3.1.0         
    FALSE 
    FALSE loaded via a namespace (and not attached):
    FALSE  [1] sys_3.4.3          rstudioapi_0.17.1  rmarkdown_2.29     fs_1.6.5           vctrs_0.6.5        memoise_2.0.1      htmltools_0.5.8.1  curl_6.2.2        
    FALSE  [9] raster_3.6-31      parallelly_1.43.0  KernSmooth_2.23-26 htmlwidgets_1.6.4  desc_1.4.3         testthat_3.2.3     zoo_1.8-13         cachem_1.1.0      
    FALSE [17] mime_0.12          lifecycle_1.0.4    pkgconfig_2.0.3    Matrix_1.7-2       R6_2.6.1           fastmap_1.2.0      rcmdcheck_1.4.0    future_1.40.0     
    FALSE [25] shiny_1.10.0       snakecase_0.11.1   digest_0.6.37      colorspace_2.1-1   furrr_0.3.1        ps_1.9.0           chron_2.3-62       rprojroot_2.0.4   
    FALSE [33] pkgload_1.4.0      timechange_0.3.0   compiler_4.4.3     proxy_0.4-27       intervals_0.15.5   bit64_4.6.0-1      withr_3.0.2        backports_1.5.0   
    FALSE [41] DBI_1.2.3          pkgbuild_1.4.7     maps_3.4.2.1       sessioninfo_1.2.3  classInt_0.4-11    tools_4.4.3        httpuv_1.6.15      glue_1.8.0        
    FALSE [49] callr_3.7.6        promises_1.3.2     grid_4.4.3         generics_0.1.3     gtable_0.3.6       tzdb_0.5.0         class_7.3-23       data.table_1.17.0 
    FALSE [57] hms_1.1.3          xml2_1.3.8         pillar_1.10.2      later_1.4.1        lattice_0.22-6     FNN_1.1.4.1        bit_4.6.0          tidyselect_1.2.1  
    FALSE [65] miniUI_0.1.1.1     knitr_1.50         gridExtra_2.3      xfun_0.51          brio_1.1.5         stringi_1.8.4      xopen_1.0.1        yaml_2.3.10       
    FALSE [73] evaluate_1.0.3     codetools_0.2-20   cli_3.6.4          arrow_19.0.1.1     xtable_1.8-4       processx_3.8.6     munsell_0.5.1      spacetime_1.3-3   
    FALSE [81] Rcpp_1.0.14        globals_0.17.0     readtext_0.91      parallel_4.4.3     ellipsis_0.3.2     fmesher_0.2.0.9016 assertthat_0.2.1   prettyunits_1.2.0 
    FALSE [89] dotCall64_1.2      profvis_0.4.0      urlchecker_1.0.1   listenv_0.9.1      scales_1.3.0       xts_0.14.1         e1071_1.7-16       purrr_1.0.4       
    FALSE [97] rlang_1.1.5        cowplot_1.1.3

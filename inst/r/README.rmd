...
link_repo <- "https://github.com/emilymarkowitz-noaa/surveyresample"
```

<!-- README.md is generated from README.Rmd. Please edit that file -->

# [surveyresample](`r link_repo`) <img src="`r paste0(link_repo, "/blob/em/img/bigelow_nefsc_bts.JPG?raw=true")`" alt="Logo." align="right" width="139" height="139"/>

...
setwd(output)
ggsave(filename = 'multi_spp_and_year_index_CV_demo.tiff',plot = last_plot() , path = output, width = 12, height = 6, device = 'tiff', dpi = 300)
...
setwd(output)
ggsave(filename = 'multi_spp_and_year_biomass_ests_SEM_demo.tiff',plot = last_plot() , path = output, width = 12, height = 6, device = 'tiff', dpi = 300)
